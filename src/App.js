...
class App extends Component {
      ...
      <div>
        <ul>
          ...
          <div class="Container" id = "data-owner-container">
            ...
            <div></div>
            <input type="submit" value="Generate PP KK" onClick={() => this.sendDataOwnerHandshake()}/>
          ...
          <div class="Container" id ="client-container">
            ...
            <div>Message id</div>
            <input id="Input-client-message-id" type="text" placeholder="message-id"/>
            <div>Slice id</div>
            <input id="Input-client-slice-id" type="text" placeholder="slice-id"/>
            <div></div>
            ...
            <input type="submit" value="Access data" onClick={() => this.sendClientRequestToAccessData()}/>
          </div>
  ...
  async sendDataOwnerRequestHandshake() {
    var process_id = document.getElementById("Input-data-owner-processid").value;
    var message = document.getElementById("Input-data-owner-message").value;

    const response = await fetch(this.api.concat("dataOwner/handshake/"), {
      method: "POST",
      body: JSON.stringify({
        'process_id': process_id,
        'message': JSON.parse(message),
